...
<script type="text/javascript" src="script/poj/js/solveHomeworkUI.js"></script>
...
<div id="divContainer" class="divContainer">
	...
	<input type="hidden" id="hwId" value="${hw.id }">
	<input type="hidden" id="proId" value="${hw.problem.id }">
		<div class="titleBar">题目说明</div>
		<div class="mainDesc">
			<table>
				<tr>
					<td class="project">题目名称</td>
					<td class="content">${hw.problem.name }</td>
				</tr>
				<tr>
					<td class="project">题目描述</td>
					<td class="content">${hw.problem.description }</td>
				</tr>
				<tr>
					<td class="project">输入示例</td>
					<td class="content">${hw.problem.inputStyle }</td>
				</tr>
				<tr>
					<td class="project">输出示例</td>
					<td class="content">${hw.problem.outputStyle }</td>
				</tr>
			</table>
		</div>
	</div>
